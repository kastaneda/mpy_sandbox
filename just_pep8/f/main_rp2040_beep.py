...
class LocalManager:
    ...
    def handle(self, topic, payload):
        if topic == 'btn':
            ...
            if payload:
                self.app.handle('beep/set', payload)
...
try:
    ...
    # Piezo buzzer
    piezo = machine.PWM(machine.Pin(2), freq=440, duty_u16=0)
    app.add(SimpleBeep(piezo, 'beep'))
